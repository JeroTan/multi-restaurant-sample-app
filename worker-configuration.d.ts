/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 702de3fc1e7762e5be0901847eacdd2e)
// Runtime types generated with workerd@1.20260424.1 2026-04-21 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OrderSync";
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_KEY" | "JWT_SECRET">> {}
}
